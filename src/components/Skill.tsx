...
const Skill = () => {
  const skills = [
    { type: "Swift", level: 93 },
    { type: "ObjectiveC", level: 84 },
    { type: "JavaScript", level: 85 },
    { type: "TypeScript", level: 81 },
    { type: "Java", level: 71 },
    { type: "HTML5", level: 81 },
    { type: "CSS3", level: 83 },
  ];
  ...
  return (
    <Container>
      ...
      <div>
        ...
        <PopupTag color="#52c41a">Backend Development</PopupTag>
        ...
        <PopupTag color="#D81D0D">TravisCI</PopupTag>
        <PopupTag color="#E3C135">Babel</PopupTag>
        <PopupTag color="#7EBBEB">Webpack</PopupTag>
        <PopupTag color="#5F37B6">Redux</PopupTag>
        <PopupTag color="#F45129">SCSS</PopupTag>
